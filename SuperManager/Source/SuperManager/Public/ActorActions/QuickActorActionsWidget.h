...
struct FRandomActorRotation
{
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="RandomizeActorTransform",meta=(EditCondition = "bRandomizeRotYaw"))
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="RandomizeActorTransform",meta=(EditCondition = "bRandomizeRotPitch"))
	...
	UPROPERTY(EditAnywhere,BlueprintReadWrite,Category="RandomizeActorTransform",meta=(EditCondition = "bRandomizeRotRoll"))
